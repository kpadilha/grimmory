...
export class SeriesBrowserComponent implements OnInit {
  ...
  // Fetches the next page once the virtualizer's last rendered row reaches the end of what's
  // loaded - the actual incremental-load trigger, not a client-side scan of the full collection.
